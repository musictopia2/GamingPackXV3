...
using bb = CommonBasicLibraries.BasicDataSettingsAndProcesses.BasicDataFunctions;
...
internal static class NativeFileAccessSetUp
{
    ...
    public static string GetParentDirectory()
    {
        ...
        else if (bb.OS == bb.EnumOS.Android) //we don't have xamarin forms.  but we know if its android so some code can run for cases where its android.
        {
