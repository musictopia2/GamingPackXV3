...
[SingletonGame]
public class MastermindMainGameClass : IAggregatorContainer
{
    private readonly ISaveSinglePlayerClass _thisState;
    private readonly IMessageBox _message;
    private readonly ISystemError _error;
    internal MastermindSaveInfo _saveRoot;
    public MastermindMainGameClass(ISaveSinglePlayerClass thisState,
        ...
        )
    {
        ...
        _message = message;
        _error = error;
        _saveRoot = container.ReplaceObject<MastermindSaveInfo>(); //can't create new one.  because if doing that, then anything that needs it won't have it.
    }
    ...
    {
        _saveRoot = await _thisState.RetrieveSinglePlayerGameAsync<MastermindSaveInfo>();
    }
