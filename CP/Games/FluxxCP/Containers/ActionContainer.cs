...
public class ActionContainer : IEnableAlways, IBasicEnableProcess
{
    ...
    public ActionContainer(CommandContainer command, IGamePackageResolver resolver, FluxxGameContainer gameContainer, FluxxDelegates delegates)
    {
        ...
        YourKeepers.AutoSelect = EnumHandAutoType.ShowObjectOnly;
        ...
        PrivateGoals.AutoSelect = EnumHandAutoType.ShowObjectOnly;
        ...
        OtherHand.AutoSelect = EnumHandAutoType.SelectOneOnly;
        ...
        TempHand.AutoSelect = EnumHandAutoType.SelectOneOnly;
