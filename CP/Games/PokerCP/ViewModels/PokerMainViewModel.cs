...
[InstanceGame]
public class PokerMainViewModel : ScreenViewModel, IBasicEnableProcess, IBlankGameVM, IAggregatorContainer
{
    private readonly PokerMainGameClass _mainGame;
    public DeckObservablePile<PokerCardInfo> DeckPile { get; set; }
    public PokerMainViewModel(IEventAggregator aggregator, CommandContainer commandContainer, IGamePackageResolver resolver) : base(aggregator)
    {
        ...
        _mainGame = resolver.ReplaceObject<PokerMainGameClass>();
    }
