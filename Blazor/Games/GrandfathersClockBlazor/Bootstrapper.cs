...
public class Bootstrapper : SinglePlayerBootstrapper<GrandfathersClockShellViewModel>
{
    ...
    {
        GrandfathersClockCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        GrandfathersClockCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        GrandfathersClockCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}