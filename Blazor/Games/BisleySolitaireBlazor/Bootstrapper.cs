...
public class Bootstrapper : SinglePlayerBootstrapper<BisleySolitaireShellViewModel>
{
    ...
    {
        BisleySolitaireCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        BisleySolitaireCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        BisleySolitaireCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}