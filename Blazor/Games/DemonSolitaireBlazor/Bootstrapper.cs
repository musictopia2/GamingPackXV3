...
public class Bootstrapper : SinglePlayerBootstrapper<DemonSolitaireShellViewModel>
{
    ...
    {
        DemonSolitaireCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        DemonSolitaireCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DemonSolitaireCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}