...
public class Bootstrapper : SinglePlayerBootstrapper<LittleSpiderSolitaireShellViewModel>
{
    ...
    {
        LittleSpiderSolitaireCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        LittleSpiderSolitaireCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        LittleSpiderSolitaireCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}