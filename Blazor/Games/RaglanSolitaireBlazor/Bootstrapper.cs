...
public class Bootstrapper : SinglePlayerBootstrapper<RaglanSolitaireShellViewModel>
{
    ...
    {
        RaglanSolitaireCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        RaglanSolitaireCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        RaglanSolitaireCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}