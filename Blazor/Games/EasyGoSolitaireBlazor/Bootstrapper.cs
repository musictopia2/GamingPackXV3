...
public class Bootstrapper : SinglePlayerBootstrapper<EasyGoSolitaireShellViewModel>
{
    ...
    {
        EasyGoSolitaireCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        EasyGoSolitaireCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        EasyGoSolitaireCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}