...
public class Bootstrapper : SinglePlayerBootstrapper<CalculationSolitaireShellViewModel>
{
    ...
    {
        CalculationSolitaireCP.DIFinishProcesses.GlobalDIAutoRegisterClass.RegisterNonSavedClasses(GetDIContainer);
    ...
    protected override void FinishRegistrations(IGamePackageRegister register)
    {
        ...
        CalculationSolitaireCP.DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        DIFinishProcesses.GlobalDIFinishClass.FinishDIRegistrations(GetDIContainer);
        CalculationSolitaireCP.AutoResumeContexts.GlobalRegistrations.Register();
    }
}